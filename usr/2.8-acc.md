...
Die [Anlagenbuchhaltung](https://de.wikipedia.org/wiki/Anlagenbuchhaltung) verwaltet Güter des Anlagevermögens. Zum [Anlagevermögen en: fixed assets](https://de.wikipedia.org/wiki/Anlageverm%C3%B6gen) gehören alle Vermögensgegenstände, die dauernd dem Geschäftsbetrieb zu dienen. Es gibt drei Untergruppen:

* Sachanlagen: Grundstücke, technische Anlagen und Maschinen, Fahrzeuge

...
Grundbuch, oder Journal bzw. Tagebuch / [(en)journals](https://en.wikipedia.org/wiki/Special_journals) : Aufzeichnung aller Geschäftsvorfälle in zeitlicher Reihenfolge:
* Eröffnungsbuchungen
* Laufende Buchungen
...
[(en)general ledger](https://en.wikipedia.org/wiki/General_ledger) : Jede Buchung im Grundbuch muss auf dem entsprechenden Sachkonto des Hauptbuches erfasst werden. Hier ergibt sich eine sachliche Ordnung aller Buchungen auf Sachkonten (Bestandskonten und Erfolgskonten). Das Hauptbuch besteht damit aus den im Kontenplan verzeichneten Sachkonten. 

Die Übertragung geschieht automatisch. Daher wird nur noch das Grundbuch geführt.
 

### Nebenbücher

[(en)general subledger](https://en.wikipedia.org/wiki/Subledger)

...
In beiden Kontenrahmen sind die [Hauptbuch/"general ledger" Sachkonten](https://de.wikipedia.org/wiki/Sachkonto) 4-stellig, für [Nebenbuch/"subledger/journal" Personen-, Kontokorrentkonten](http://wirtschaftslexikon.gabler.de/Archiv/10929/personenkonten-v7.html) werden folgende 5-stellige Nummerkreise vorgeschlagen:
...
* [en.wikipedia zu Begriff "subledger/journal"](https://en.wikipedia.org/wiki/Special_journals)
